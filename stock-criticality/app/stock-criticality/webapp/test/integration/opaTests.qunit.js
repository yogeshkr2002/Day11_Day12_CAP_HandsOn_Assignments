...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "stockcriticality/stockcriticality/test/integration/FirstJourney",
    "stockcriticality/stockcriticality/test/integration/ProductsListJourney",
    "stockcriticality/stockcriticality/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
